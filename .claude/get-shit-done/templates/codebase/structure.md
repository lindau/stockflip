...
- Usage: Reference from command with `@/Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
