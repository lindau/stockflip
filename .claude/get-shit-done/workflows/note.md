...
- **Global scope**: `/Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/notes/`)
...
2. Glob `/Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/johanlindau/SynologyDrive/Kodprojekt/StockFlip/.claude/notes/` — works in any directory
