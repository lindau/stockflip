...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView stockPairsList;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.stockPairsList;
      RecyclerView stockPairsList = ViewBindings.findChildViewById(rootView, id);
      if (stockPairsList == null) {
        break missingId;
      }
